    ...
    <div class="w-full max-w-2xl mx-auto bg-white min-h-screen md:min-h-[850px] md:h-[850px] md:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col relative border border-slate-100">
      ...
      <header class="sticky top-0 z-20 bg-white/95 backdrop-blur-sm border-b border-slate-100 px-6 pt-4 pb-4 md:rounded-t-[3rem]">
        <div class="flex items-center justify-between mb-4">
          ...
          <button @click="logout" class="flex size-10 items-center justify-center rounded-full bg-transparent text-slate-900 hover:bg-slate-50 transition-colors">
      ...
      <div class="absolute bottom-24 right-6 z-30">
        <button @click="openCreateModal" class="bg-primary hover:bg-primary/90 text-white rounded-2xl h-16 px-6 shadow-lg shadow-primary/20 flex items-center gap-3 transition-transform active:scale-95 group">
      ...
      <nav class="absolute bottom-0 z-20 w-full bg-white border-t border-slate-100 pb-8 pt-4 px-6 flex justify-between items-center text-[10px] font-bold tracking-wide text-slate-500 uppercase md:rounded-b-[3rem]">
        ...
        <button @click="router.push('/superadmin/dashboard')" class="flex flex-col items-center gap-1.5 hover:text-primary transition-colors">
        ...
        <button class="flex flex-col items-center gap-1.5 text-primary transition-colors">
          <span class="material-symbols-outlined text-[26px]" style="font-variation-settings: 'FILL' 1">category</span>
          Categorías
        </button>
